...
<head>
    ...
    <style>
        ...
        #submit
        {
            background-image: linear-gradient(to right, rgb(111, 228, 96), rgb(30, 148, 0));
            width: 100%;
            border: none;
            padding: 15px;
            color: white;
        ...
        #submit:hover
        {
            background-image: linear-gradient(to right, rgb(113, 255, 95), rgb(20, 94, 2));
        }
...
<form>
	...
	<select class="form-control" readonly="readonly" tabindex="-1" aria-disabled="true"  id="estado" onchange="buscaCidades(this.value)">
